    ...
    <div className="mt-48">
      <div>
        <div className='text-center'>
          <span className='font-extrabold text-transparent text-5xl bg-clip-text bg-black'>About </span>
          <span className='font-extrabold text-transparent text-5xl bg-clip-text bg-gradient-to-r from-blue-800 to-purple-500'>NoteVision</span>
        </div>
      </div>
      <div className='mt-32 text-center mx-[5%]'>
      <Accordion open={open === 1}>
        <AccordionHeader className='w-auto ml-[43.5%]' onClick={() => { handleOpen(1) }}>
      ...
      <Accordion open={open === 2}>
        <AccordionHeader className='w-auto ml-[45.6%]' onClick={() => { handleOpen(2) }}>
          Split Your Notes
        </AccordionHeader>
        <AccordionBody className='text-lg'>
      ...
      <Accordion open={open === 3}>
        <AccordionHeader className='w-auto ml-[45.1%]' onClick={() => { handleOpen(3) }}>
          Create Mind Maps
        </AccordionHeader>
        <AccordionBody className='text-lg'>
      ...
      <Accordion open={open === 4}>
        <AccordionHeader className='w-auto ml-[46.8%]' onClick={() => { handleOpen(4) }}>
          Our Journey
        </AccordionHeader>
        <AccordionBody className='text-lg' >
      ...
      <Accordion open={open === 5}>
        <AccordionHeader className='w-auto ml-[43.2%]' onClick={() => { handleOpen(5) }}>
      ...
      <Accordion open={open === 6}>
        <AccordionHeader className='w-auto ml-[48.1%]' onClick={() => { handleOpen(6) }}>
          Join Us
        </AccordionHeader>
        <AccordionBody className='text-lg' >
